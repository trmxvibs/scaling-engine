#!/usr/bin/env python3
"""
Instagram OSINT Tool — enhanced version
by trmxvibs (enhanced)

Features:
- Robust extraction of profile and recent posts from multiple JSON embeddings in the page
- Extraction of emails, phones, urls, hashtags, mentions from bio & captions
- Optional download of images
- EXIF extraction including GPS -> lat/lon + reverse geocoding (Nominatim via geopy)
- Session with retries and timeouts
- JSON output file support
- CLI flags to enable/disable features
Note: Instagram may change page structure or block scraping; for heavy use consider authenticated sessions / official API.
"""
import argparse
import json
import logging
...
MAX_POSTS = 12  # number of recent posts to extract
